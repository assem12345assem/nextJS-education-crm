    ...
    try {
        switch (req.method){
            ...
            case "POST": {
                ...
                if (role === 'curator') {
                    const profile: InstructorProfile = req.body.profile;
                    ...
                    return res.json({message: "Successfully created Mentor profile."});
                } else
            ...
            case "PUT": {
                ...
                if (role === 'curator') {
                    ...
                    return res.json({message: "Successfully edited Mentor profile."});
                } else
                    return res.status(400).json({message: "You don't have privileges."})
            }
            default:
